...
# pd.DataFrame(emoji_df).to_csv("./out.csv", encoding='utf-8', index=False)
...
#
# pd.DataFrame(nodes).to_csv("./nodes.csv", encoding='utf-8', index=False)
...
#                 i += 1
#
# pd.DataFrame(edges).to_csv("./edges.csv", encoding='utf-8', index=False)